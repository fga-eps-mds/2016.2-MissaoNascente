...
public class ElementsController {
    ...
    protected void createElement(Context context) {
        ...
        try {
            ...
            setElement(new Element(1, 1, 100, "ponto_2", "Pau-Santo", 1, description, -10));
            ...
            setElement(new Element(2, 2, 200, "ponto_3", "Jacarandá do Cerrado", 1, description, 30));
            elementDao.insertElement(getElement());
            ...
            setElement(new Element(3, 3, 300, "ponto_5", "Paineira do Cerrado", 2, description, -10));
            elementDao.insertElement(getElement());
            ...
            setElement(new Element(4, 4, 400, "ponto_6", "Cupinzeiro terrestre", 2, description, 30));
            elementDao.insertElement(getElement());
            ...
            setElement(new Element(5, 5, 500, "ponto_23", "Nascente do córrego Cabeça de Veado", 3, description, -10));
            elementDao.insertElement(getElement());
            ...
            setElement(new Element(6, 6, 600, "ponto_34", "Gavinha", 3, description, 30));
            elementDao.insertElement(getElement());
